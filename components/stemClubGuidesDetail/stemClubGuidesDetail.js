...
class StemClubGuidesDetail extends Component {
    state = {  } 
    render() { 
        return (
            <div className='bg-light-grey'>
                <div className='container py-5'>
                    <h2 className='heading mb-5'>STEAM Club Guides</h2>
                    <div className='row pt-5'>
                        <div className='col-12 col-sm-3'>
                            <div className='book text-center text-sm-start mb-4'>
                                ...
                                <p className='title book py-4 mb-0'>STEAM Clubs Guide <br />(English)</p>
                    ...
                    <div className='row pt-5'>
                        <div className='col-12 col-sm-3'>
                            <div className='book text-center text-sm-start mb-4'>
                                ...
                                <p className='title book py-4 mb-0'>STEAM Clubs Guide <br />(Urdu)</p>
...
export default StemClubGuidesDetail;